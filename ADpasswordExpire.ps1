...
# Inspired by Robert Pearman (WSSMB MVP) -https://gallery.technet.microsoft.com/Password-Expiry-Email-177c3e27
#
# Written with love by Mr.H1deZ
# You can modify the script how you want it just keep the good work and announce the original.
#
